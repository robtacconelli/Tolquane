...
| `networkTest`, `pipeline_network`, `ff_tests/combine2_network_feedback`, `benchmarks/distributed/benchmark_network`, `benchmarks/distributed/benchmark_network_farm` | TCP channels between processes or machines | deferred to the distributed runtime (Phase 5); listed as skipped tests in `tests/test_bbflow_ports.py::test_network_programs` |
